...
import admin from "./fragments/admin-it";
...
const it: Translation = {
  ...
  booking: {
    ...
    payment: {
      ...
      emailSyncWarn: "L'email di conferma non è stata inviata: {{detail}}",
    },
  },
  footer: {
    ...
    pageNavAria: "Naviga tra le sezioni principali del sito",
    prev: "Indietro",
    next: "Avanti",
    pagePosition: "Pagina {{current}} di {{total}}",
  },
  admin,
  language: "Lingua",
};
