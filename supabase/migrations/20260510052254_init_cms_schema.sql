...
--   shopComingSoonEnabled/Title/Message, emailFromName, emailAutomationBooking, emailAutomationContact.
...
--
-- Slugs em `doulas` alinhados ao site estático / marcação (incl. booking): founder, sofia, elena, mei.
